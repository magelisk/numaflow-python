...
MAP_BATCH_SERVER_INFO_FILE_PATH = "/var/run/numaflow/mapbatch-server-info"
...
# MAP_SERVER_INFO_FILE_PATH = "/var/run/numaflow/server-info"
# MAP_STREAM_SERVER_INFO_FILE_PATH = "/var/run/numaflow/server-info"
# REDUCE_SERVER_INFO_FILE_PATH = "/var/run/numaflow/server-info"
# REDUCE_STREAM_SERVER_INFO_FILE_PATH = "/var/run/numaflow/server-info"
# SOURCE_TRANSFORMER_SERVER_INFO_FILE_PATH = "/var/run/numaflow/server-info"
# SINK_SERVER_INFO_FILE_PATH = "/var/run/numaflow/server-info"
# SIDE_INPUT_SERVER_INFO_FILE_PATH = "/var/run/numaflow/server-info"
# SOURCE_SERVER_INFO_FILE_PATH = "/var/run/numaflow/server-info"
# FALLBACK_SINK_SERVER_INFO_FILE_PATH = "/var/run/numaflow/server-info"
