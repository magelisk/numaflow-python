...
class MapStreamStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.MapStreamFn = channel.stream_stream(
...
class MapStreamServicer(object):
    ...
    def MapStreamFn(self, request_iterator, context):
...
def add_MapStreamServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'MapStreamFn': grpc.stream_stream_rpc_method_handler(
...
class MapStream(object):
    ...
    @staticmethod
    def MapStreamFn(request_iterator,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/mapstream.v1.MapStream/MapStreamFn',
    ...
    def IsReady(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/mapstream.v1.MapStream/IsReady',
