...
# from pynumaflow.flatmap import Datum
# from pynumaflow.flatmap._dtypes import MapStreamCallable
...
# class AsyncMapStreamServicer(flatmap_pb2_grpc.FlatmapServicer):
#     """
...
#         Flatmap one
#         """
#         _LOGGER.info("MDW: Real Flatmap MapStreamFn")
#         datum_iterator = datum_generator(request_iterator=request_iterator)
