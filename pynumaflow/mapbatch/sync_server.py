...
from pynumaflow.mapbatch.servicer.sync_servicer import SyncBatchMapServicer
...
class MapBatchServer(NumaflowServer):
    """
    ...
    Example Invocation:
        from pynumaflow.mapbatch import Messages, Message, Datum, MapServer, Mapper
    ...
    def __init__(
        self,
        mapper_instance: MapBatchSyncCallable,
        ...
        self.servicer = SyncBatchMapServicer(handler=mapper_instance)
