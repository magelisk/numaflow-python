...
proto:
	...
	python3 -m grpc_tools.protoc -I=pynumaflow/proto/flatmap --python_out=pynumaflow/proto/flatmap --grpc_python_out=pynumaflow/proto/flatmap  pynumaflow/proto/flatmap/*.proto
